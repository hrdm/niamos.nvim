...
function M.set_colors()
  ...
  Color.new("x_green", "#4eab98")
  Color.new("x_red", "#c02a70")
  Color.new("x_purple", "#8220b3")
  Color.new("x_orange", "#cf5136")
  Color.new("x_blue", "#589aa7")
  Color.new("x_black", "#474747")
  Color.new("x_skyblue", "#5094c8")
  ...
  Group.new("String", colors.x_blue, colors.none, styles.none)
  ...
  if fn.has("nvim-0.8.0") ~= 0 then
    ...
    Group.new("@operator", colors.x_black)

    Group.new("@punctuation.delimiter", colors.x_orange, colors.none, styles.none)
    -- Group.link("@punctuation.delimiter", groups.Statement)
    Group.new("@punctuation.bracket", colors.x_dark_blue, colors.none, styles.none)
    Group.new("@punctuation.special", colors.x_light_green, colors.none, styles.none)
    ...
    Group.new("@number", colors.x_dark_orange)
    Group.link("@float", groups.Float)

    -- Group.link("@function", groups.Function)
    Group.new("@function", colors.x_purple, colors.none, styles.none)
    -- Group.link("@function.call", groups.Function)
    Group.new("@function.call", colors.x_purple)
    Group.new("@function.builtin", colors.x_purple)
    ...
    Group.new("@keyword", colors.x_green, colors.none, styles.none)
    Group.new("@keyword.function", colors.x_red, colors.none, styles.none)
    ...
    Group.new("@type.builtin", colors.x_skyblue)
    ...
    Group.new("@variable", colors.x_black)
    -- Group.link("@variable.builtin", groups.Special)
    Group.new("@variable.parameter", colors.x_orange, colors.none, styles.none)
  ...
  if fn.has("nvim-0.9.0") ~= 0 then
    ...
    Group.new("SnacksIndentScope", colors.b_green, colors.none, styles.none)
