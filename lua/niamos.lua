...
function M.set_colors()
  ...
  Group.new('NormalFloat', colors.none, colors.indian_grey:light():light(), styles.None)
  ...
  -- Group.new('Statement', colors.indian_light_green:dark(), colors.none, styles.none)
  ...
  Group.new('Pmenu', colors.white, colors.indian_grey, styles.None)
  Group.new('PmenuSel', colors.white, colors.indian_green:light(), styles.None)
  ...
  Group.new('GitSignsAdd', colors.indian_green, colors.indian_green:light():light():light():light():light(),
    styles.none)
  Group.new('GitSignsChange', colors.yellow, colors.yellow:light():light():light():light(), styles.none)
  Group.new('GitSignsDelete', colors.indian_red, colors.indian_red:light():light():light(), styles.none)
  ...
  Group.new('GitSignsStagedAddCul', colors.indian_light_cherry, colors.indian_light_cherry:light():light():light(),
    styles.none)
  Group.new('GitSignsStagedAddNr', colors.indian_light_cherry, colors.indian_light_cherry:light():light():light(),
    styles.none)
  Group.new('GitSignsStagedAddln', colors.indian_light_cherry, colors.indian_light_cherry:light():light():light(),
    styles.none)
  Group.new('GitSignsStagedAdd', colors.indian_light_cherry, colors.indian_light_cherry:light():light():light(),
    styles.none)
  ...
  -- Group.new('SagaFolderName', colors.base0, colors.none, styles.none)
  -- Group.new('SagaFileName', colors.base0, colors.none, styles.none)
  ...
  Group.new('FinderParam', colors.indian_green, colors.indian_green:light():light():light():light():light(),
    styles.none)
  ...
  Group.new('DiagnosticInfo', colors.indian_exp_blue, colors.indian_exp_blue:light():light():light():light(),
    styles.none)
  Group.new('DiagnosticSignInfo', colors.indian_exp_blue, colors.none, styles.none)
  -- Group.new("DiagnosticHint", colors.green)
  Group.new('DiagnosticHint', colors.indian_green, colors.indian_green:light():light():light():light():light(),
    styles.none)
