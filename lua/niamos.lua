...
function M.set_colors()
  ...
  Group.new("MoreMsg", colors.indian_blue, colors.indian_blue:light():light():light(), styles.none)
  ...
  Group.new("MsgSeparator", colors.indian_light_green, colors.none, styles.underline)
