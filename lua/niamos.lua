...
function M.set_colors()
  ...
  Group.new("GitSignsAdd", colors.indian_green, colors.none, styles.none)
  ...
  Group.new("GitSignsStagedChangeCul", colors.indian_light_cherry, colors.none, styles.bold)
  Group.new("GitSignsStagedChangeDeleteCul", colors.indian_light_cherry, colors.none, styles.bold)
  -- Group.new(
