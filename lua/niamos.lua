...
function M.set_colors()
  ...
  Color.new("b_yellow_lt_02", "#fff9e5")
  ...
  Group.new("Search", colors.b_yellow, b_yellow_lt_02, styles.None)

  Group.new("CurSearch", colors.b_red, b_yellow_lt_02, styles.None)
  ...
  Group.new("DiffChange", colors.yellow, b_yellow_lt_02, styles.none)
  ...
  Group.new("DiagnosticWarn", colors.b_yellow, b_yellow_lt_02, styles.none)
