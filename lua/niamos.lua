...
function M.set_colors()
  ...
  Group.new("GitSignsStagedChangeLn", colors.indian_light_cherry, colors.none, styles.bold)
  Group.new("GitSignsStagedChangeDeleteLn", colors.indian_light_cherry, colors.none, styles.bold)
  -- Group.new(
