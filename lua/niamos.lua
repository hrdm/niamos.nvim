...
function M.set_colors()
  ...
  Group.new("ErrorMsg", colors.b_red, colors.b_red:light():light():light(), styles.none)
  Group.new("MsgArea", colors.indian_light_green, colors.none, styles.none)

  Group.new("IncSearch", colors.b_red, colors.b_red:light():light(), styles.None)
  Group.new("Search", colors.b_yellow, colors.b_yellow:light():light():light():light(), styles.None)

  Group.new("CurSearch", colors.b_red, colors.b_yellow:light():light():light():light(), styles.None)
  ...
  Group.new("LspSagaAutoPreview", colors.b_red, colors.b_red:light():light():light(), styles.bold)
  ...
  Group.new("DefinitionBorder", colors.b_red, colors.b_red:light():light():light(), styles.bold)
  ...
  Group.new("TelescopePreviewBorder", colors.b_red, colors.b_red:light():light():light(), styles.none)
  ...
  Group.new("DiagnosticError", colors.b_red, colors.b_red:light():light():light(), styles.none)
  Group.new("DiagnosticWarn", colors.b_yellow, colors.b_yellow:light():light():light():light(), styles.none)
