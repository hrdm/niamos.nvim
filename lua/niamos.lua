...
function M.set_colors()
  ...
  Group.new("Identifier", colors.s_blue:dark(), colors.none, styles.none)
  ...
  Group.new("DiagnosticInfo", colors.s_blue, colors.s_blue:light():light():light():light(), styles.none)
